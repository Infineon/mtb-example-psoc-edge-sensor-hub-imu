...
The following example clones the "[Sensor hub data acquisition](https://github.com/Infineon/mtb-example-psoc-edge-sensor-hub-imu)" application with the desired name "SensorHub" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-sensor-hub-imu --user-app-name SensorHubIMU --target-dir "C:/mtb_projects"
   ```
